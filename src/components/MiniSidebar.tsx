...
export function MiniSidebar() {
  ...
  return (
    <main className="basis-[5rem] flex flex-col bg-[#f9f9f9] w-full h-full">
      <div className="flex items-center justify-center h-[5rem]">Logo</div>
      ...
      <div className="mt-8 flex-1 flex flex-col items-center justify-between">
        ...
        <div className="mb-[1.5rem]">
          <button className="w-12 h-12 flex justify-center items-center border-2 rounded-full">
